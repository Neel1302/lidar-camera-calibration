...
# ** DO NOT USE camera_matrix from ost.yaml file as K since it doesn't include distortion parameters
     and hence running projection in next step on rect (instead of raw) image will not be correct **
...
# Enter the name of the file for the LIDAR to CAMERA C_T_L transformation matrix and the projection matrix C_proj_L that
# you would like to save - saves a numpy file
